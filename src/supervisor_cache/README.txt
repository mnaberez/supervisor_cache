...
Overview
  ...
  Occasionally, it is useful to be able to store similar kinds of
  identification or marker information in Supervisor and be able to modify it
  without restarting Supervisor. This is the use case for supervisor_cache.
  This package is not a replacement for systems like memcached.
